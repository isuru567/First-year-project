    ...
    <header class="header">
            ...
            <div class="nnav">
                <nav>
                    ...
                    <button type="button" class="btn3">Search</button></center>
                    </form>
                </div>
        </header><br>
        <div class="box1">
            <ul class="menubar">
                <li><a class="a1" href="src/tj.html">Trending Jobs</a></li>
                <li><a class="a1" href="src/pj.html">Part Time</a></li>
                <li><a class="a1" href="rc/online_jobs.html>Full Time</a></li>
                <li><a class="a1" href="src/online_jobs.html">Online Jobs</a></li>
            </ul>
        </div> <br><br><br>
